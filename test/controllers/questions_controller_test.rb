...
class QuestionsControllerTest < ActionController::TestCase
  ...
  test "should update question" do
    patch :update, id: @question, question: { answer_1: @question.answer_1, answer_2: @question.answer_2, answer_3: @question.answer_3, answer_4: @question.answer_4, answer_5: @question.answer_5, question: @question.question }
    assert_redirected_to question_path(assigns(:question))
  end
