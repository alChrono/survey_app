...
* Design for Survey Takin
	- Add extra columns to the the Entity that stores Survey/Question relation
...
* Design for Tracking user survey/question result
	- Create a new ActiveRecord Entity with the columns user ID, survey ID, question ID and answer
